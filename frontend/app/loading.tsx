  ...
  return (
    <main className="relative z-10 min-h-screen flex items-center justify-center px-6">
      <div className="text-center">
        <div className="font-mono text-[10px] uppercase tracking-wider text-ink-dim mb-3 flex items-center gap-2 justify-center">
          <span className="inline-block h-1.5 w-1.5 rounded-full bg-tier-act-now animate-pulse-soft" />
